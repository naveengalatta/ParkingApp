...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUSerInfo() {
        ...
        Toast.makeText(SettingsActivity.this,"Infomation Updated",Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void uploadImage() {
        ...
        progressDialog.setMessage("Please wait until your information is uploaded");
